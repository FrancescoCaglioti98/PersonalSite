...
experiences:
  - role: "Backend Engineer"
    ...
    location: "Milano"
    period: "2024 - oggi"
    description: "Lavoro come Backend Developer in un team Agile, partecipando a **Sprint Planning**, **Daily Stand-up**, e Retrospettive per migliorare continuamente i processi di sviluppo."
    highlights:
  ...
  - role: "Web Developer"
    ...
    location: "Lissone"
    period: "2022 - 2024"
    description: "Ho lavorato come Sviluppatore Web in un'azienda che si occupava della distribuzione di un sistema ERP proprietario, progettato specificamente per le piccole e medie imprese. Questo sistema era caratterizzato da una profonda integrazione con i gestionali Microarea, offrendo soluzioni su misura per le esigenze aziendali."
    highlights:
  ...
  - role: "Altre esperienze lavorative"
    period: "2020 - 2022"
